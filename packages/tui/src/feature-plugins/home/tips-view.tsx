...
const TIPS: Tip[] = [
  ...
  "Maskode anonymizes sensitive data in attached text files before model requests",
  "Use {highlight}maskode run{/highlight} for non-interactive scripting",
  "Use {highlight}maskode --continue{/highlight} to resume the last session",
  "Use {highlight}maskode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}maskode serve{/highlight} for headless API access to Maskode",
  "Use {highlight}maskode run --attach{/highlight} to connect to a running server",
  "Run {highlight}maskode auth list{/highlight} to see all configured providers",
  "Run {highlight}maskode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}maskode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}maskode debug config{/highlight} to troubleshoot configuration",
